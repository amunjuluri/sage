...
export default function TeacherLogin() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const result = authenticateUser(email, password, 'teacher');
    
    if (result.success) {
      // In a real app, we would use proper authentication with cookies/JWT
      // For now, we'll just store in sessionStorage
      sessionStorage.setItem('teacher', JSON.stringify(result.user));
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Access your teacher portal and help students
          </p>
        </div>
        ...
        <div className="mt-6 border-t border-gray-200 pt-4">
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-2">
            <button 
              ...
              onClick={() => {
                setEmail('professor1@university.edu');
            ...
            <button 
              className="text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 rounded"
              onClick={() => {
                setEmail('professor2@university.edu');
                setPassword('teacher123');
              }}
            >
              Prof. Chen
            ...
            <button 
              className="text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 rounded"
              onClick={() => {
                setEmail('professor3@university.edu');
                setPassword('teacher123');
              }}
            >
              Dr. Patel
